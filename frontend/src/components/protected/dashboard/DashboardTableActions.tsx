...
interface DashboardTableActionsProps<TData extends DashboardTblItem> {
  row: Row<TData>;
}

const DashboardTableActions = <TData extends DashboardTblItem>({
  row,
}: DashboardTableActionsProps<TData>) => {
